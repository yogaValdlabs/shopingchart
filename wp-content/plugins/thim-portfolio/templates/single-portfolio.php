...
<section class="container <?php echo $pf_layout;?>">	
	...
	<?php while ( have_posts() ) : the_post(); ?>
		<?php 
			...
			}else if (get_post_meta( get_the_ID(), 'selectPortfolio', true ) ==  "portfolio_type_4") {
				thim_get_template_part( 'portfolio-type', 'left-floating-sidebar' );
			}else if (get_post_meta( get_the_ID(), 'selectPortfolio', true ) ==  "portfolio_type_5") {
				thim_get_template_part( 'portfolio-type', 'right-floating-sidebar' );
			}else if (get_post_meta( get_the_ID(), 'selectPortfolio', true ) ==  "portfolio_type_8") {
				thim_get_template_part( 'portfolio-type', 'gallery' );
			}else if (get_post_meta( get_the_ID(), 'selectPortfolio', true ) ==  "portfolio_type_9") {
				thim_get_template_part( 'portfolio-type', 'vertical-stacked' );
			}else if (get_post_meta( get_the_ID(), 'selectPortfolio', true ) ==  "portfolio_type_7") {
