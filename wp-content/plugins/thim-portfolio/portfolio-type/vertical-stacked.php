...
<article id="post-<?php the_ID(); ?>" <?php post_class('portfolio-format-vertical-stacked'); ?>>
	<div class="row entry-content-portfolio">
		<div class="entry-content-left col-sm-9">
			...
			<?php
			wp_link_pages( array(
				'before' => '<div class="page-links">' . __( 'Pages:', 'thimpress' ),
				'after'  => '</div>',
			) );
			?>
		</div>
		<div class="entry-content-right col-sm-3">
			...
			<div class="link-project">
				<a href="<?php echo get_post_meta( get_the_ID(), 'project_link', true );?>" target="_blank" class="sc-btn">Link project</a>
			</div>
			<?php } ?>
		</div>
