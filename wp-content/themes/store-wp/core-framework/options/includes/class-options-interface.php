...
class IGthemes_Options_Framework_Interface {

/**
 * Generates the tabs that are used in the options menu
 */
    static function igthemes_optionsframework_tabs() {
        $counter = 0;
 ...
 */
    static function igthemes_optionsframework_fields() {
        ...
        if ( isset( $igthemes_optionsframework_settings['id'] ) ) {
            ...
            $option_name = 'igthemes-optionsframework';
        };
        ...
        foreach ( $options as $value ) {
            ...
            if ( has_filter( 'igthemes_optionsframework_' . $value['type'] ) ) {
                $output .= apply_filters( 'igthemes_optionsframework_' . $value['type'], $option_name, $value, $val );
            }
            ...
            // Uploader
            case "upload":
                $output .= IGthemes_Options_Framework_Media_Uploader::igthemes_optionsframework_uploader( $value['id'], $val, null );
            ...
            case 'typography':
                ...
                $typography_options = array(
                    'sizes' => igthemes_recognized_font_sizes(),
                    'faces' => igthemes_recognized_font_faces(),
                    'styles' => igthemes_recognized_font_styles(),
                    'color' => true
                );
                ...
                $typography_fields = apply_filters( 'igthemes_typography_fields', $typography_fields, $typography_stored, $option_name, $value );
            ...
            case 'background':
                ...
                $output .= IGthemes_Options_Framework_Media_Uploader::igthemes_optionsframework_uploader( $value['id'], $background['image'], null, esc_attr( $option_name . '[' . $value['id'] . '][image]' ) );
                ...
                $repeats = igthemes_recognized_background_repeat();
                ...
                $positions = igthemes_recognized_background_position();
                ...
                $attachments = igthemes_recognized_background_attachment();
        ...
        if ( IGthemes_Options_Framework_Interface::igthemes_optionsframework_tabs() != '' ) {
            echo '</div>';
        }
    }
