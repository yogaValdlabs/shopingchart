...
<div class="social-url">
        ...
        <?php if ( igthemes_get_option('dribbble_url') ) {
         ...
         <?php if ( igthemes_get_option('vimeo_url') ) {
        ...
        <?php if ( igthemes_get_option('youtube_url') ) {
        ...
        <?php if ( igthemes_get_option('rss_url') ) {
