...
function igthemes_customize_preview_js() {
	wp_enqueue_script( 'igthemes_customizer', get_template_directory_uri() . '/core-framework/js/customizer.js', array( 'customize-preview' ), '20130508', true );
}
