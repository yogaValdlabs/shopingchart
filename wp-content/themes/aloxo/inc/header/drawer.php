...
<div id="rt-drawer" class="<?php if ( isset( $theme_options_data['drawer_style'] ) ) {
		echo $theme_options_data["drawer_style"];
	} ?>">
 		<div class="container">
			<div class="row">
				<?php
				if (isset($theme_options_data['drawer_open']) && $theme_options_data['drawer_open'] == 1) {
