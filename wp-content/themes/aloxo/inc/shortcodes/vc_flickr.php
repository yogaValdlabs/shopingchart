<?php
add_shortcode( 'vc_flickr', 'shortcode_vc_flickr' );
function shortcode_vc_flickr( $atts, $content = null ) {
	...
	$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'wpb_flickr_widget wpb_content_element' . $el_class, 'vc_flickr', $atts );
	...
	$output .= "\n\t\t\t".'<p class="flickr_stream_wrap"><a class="wpb_follow_btn wpb_flickr_stream" href="http://www.flickr.com/photos/'. $flickr_id .'">'.'</a></p>';
	$output .= "\n\t\t".'</div>';
	$output .= "\n\t".'</div>';
