		...
		public function display() {
			...
			if ( strlen( $license ) > 0 ) {
				...
				switch( $status ) {
					...
					case 'valid':
						?><p class="description"><?php esc_attr_e( 'Your license is valid and active.', TF_I18NDOMAIN ); ?></p><?php
					break;

					case 'invalid':
						?><p class="description"><?php esc_attr_e( 'Your license is invalid.', TF_I18NDOMAIN ); ?></p><?php
					break;
					...
					case 'inactive':
						...
						?>
						<a href="<?php echo esc_url($url); ?>" class="button-secondary"><?php esc_attr_e( 'Activate', TF_I18NDOMAIN ); ?></a>
						<p class="description"><?php esc_attr_e( 'Your license is valid but inactive. Click the button above to activate it.', TF_I18NDOMAIN ); ?></p><?php

					break;

					case 'no_response':
						?><p class="description"><?php esc_attr_e( 'The remote server did not return a valid response. You can retry by hitting the &laquo;Save&raquo; button again.', TF_I18NDOMAIN ); ?></p><?php
					break;

				}

			} else {
				?><p class="description"><?php esc_attr_e( 'Entering your license key is mandatory to get the product updates.', TF_I18NDOMAIN ); ?></p><?php
			}
