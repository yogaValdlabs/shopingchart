    ...
    class TitanFrameworkOptionColorOpacityControl extends WP_Customize_Control {
        ...
        public function render_content() { 
            ...
            <label>
                ...
                <input type="text" data-default-color="<?php echo $this->value() ?>" value="<?php echo $this->value(); ?>" class="thim-color-control color-picker-hex wp-color-picker" <?php $this->link(); ?>  />
            </label>
        <?php 
